...
/* If the component want to share output buffer with sink element
 * enable it could save bandwidth usage. only for video decoder
 */
#define GST_OMX_HACK_SHARE_OUTPORT_BUFFER                             G_GUINT64_CONSTANT (0x0000000000000200)
