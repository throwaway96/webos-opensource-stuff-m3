...
#ifndef __GST_OMX_MP2_DEC_H__
#define __GST_OMX_MP2_DEC_H__
...
#define GST_TYPE_OMX_MP2_DEC \
  (gst_omx_mp2_dec_get_type())
#define GST_OMX_MP2_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_OMX_MP2_DEC,GstOMXMP2Dec))
#define GST_OMX_MP2_DEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_OMX_MP2_DEC,GstOMXMP2DecClass))
#define GST_OMX_MP2_DEC_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj),GST_TYPE_OMX_MP3_DEC,GstOMXMP2DecClass))
#define GST_IS_OMX_MP2_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_OMX_MP2_DEC))
#define GST_IS_OMX_MP2_DEC_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_OMX_MP2_DEC))

typedef struct _GstOMXMP2Dec GstOMXMP2Dec;
typedef struct _GstOMXMP2DecClass GstOMXMP2DecClass;

struct _GstOMXMP2Dec
{
  GstOMXAudioDec parent;
  gint spf;
};

struct _GstOMXMP2DecClass
{
  GstOMXAudioDecClass parent_class;
};

GType gst_omx_mp2_dec_get_type (void);

G_END_DECLS

#endif /* __GST_OMX_MP2_DEC_H__ */
