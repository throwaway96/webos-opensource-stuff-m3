...
#ifndef __GST_OMX_HEVC_DEC_H__
#define __GST_OMX_HEVC_DEC_H__
...
#define GST_TYPE_OMX_HEVC_DEC \
  (gst_omx_HEVC_dec_get_type())
#define GST_OMX_HEVC_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_OMX_HEVC_DEC,GstOMXHEVCDec))
#define GST_OMX_HEVC_DEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_OMX_HEVC_DEC,GstOMXHEVCDecClass))
#define GST_OMX_HEVC_DEC_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj),GST_TYPE_OMX_VP8_DEC,GstOMXHEVCDecClass))
#define GST_IS_OMX_HEVC_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_OMX_HEVC_DEC))
#define GST_IS_OMX_HEVC_DEC_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_OMX_HEVC_DEC))

typedef struct _GstOMXHEVCDec GstOMXHEVCDec;
typedef struct _GstOMXHEVCDecClass GstOMXHEVCDecClass;

struct _GstOMXHEVCDec
{
  GstOMXVideoDec parent;
};

struct _GstOMXHEVCDecClass
{
  GstOMXVideoDecClass parent_class;
};

GType gst_omx_hevc_dec_get_type (void);

G_END_DECLS

#endif /* __GST_OMX_HEVC_DEC_H__ */
