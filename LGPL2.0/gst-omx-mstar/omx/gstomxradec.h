...
#ifndef __GST_OMX_RA_DEC_H__
#define __GST_OMX_RA_DEC_H__
...
#define GST_TYPE_OMX_RA_DEC \
  (gst_omx_ra_dec_get_type())
#define GST_OMX_RA_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_OMX_RA_DEC,GstOMXRADec))
#define GST_OMX_RA_DEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_OMX_RA_DEC,GstOMXRADecClass))
#define GST_OMX_RA_DEC_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj),GST_TYPE_OMX_RA_DEC,GstOMXRADecClass))
#define GST_IS_OMX_RA_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_OMX_RA_DEC))
#define GST_IS_OMX_RA_DEC_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_OMX_RA_DEC))

typedef struct _GstOMXRADec GstOMXRADec;
typedef struct _GstOMXRADecClass GstOMXRADecClass;
...
struct _GstOMXRADecClass
{
  GstOMXAudioDecClass parent_class;
};

GType gst_omx_ra_dec_get_type (void);

G_END_DECLS

#endif /* __GST_OMX_RA_DEC_H__ */
