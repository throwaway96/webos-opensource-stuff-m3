...
#ifndef __GST_OMX_VC1_DEC_H__
#define __GST_OMX_VC1_DEC_H__
...
#define GST_TYPE_OMX_VC1_DEC \
  (gst_omx_vc1_dec_get_type())
#define GST_OMX_VC1_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_OMX_VC1_DEC,GstOMXVC1Dec))
#define GST_OMX_VC1_DEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_OMX_VC1_DEC,GstOMXVC1DecClass))
#define GST_OMX_VC1_DEC_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj),GST_TYPE_OMX_VC1_DEC,GstOMXVC1DecClass))
#define GST_IS_OMX_VC1_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_OMX_VC1_DEC))
#define GST_IS_OMX_VC1_DEC_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_OMX_VC1_DEC))

typedef struct _GstOMXVC1Dec GstOMXVC1Dec;
typedef struct _GstOMXVC1DecClass GstOMXVC1DecClass;

struct _GstOMXVC1Dec
{
  GstOMXVideoDec parent;
};

struct _GstOMXVC1DecClass
{
  GstOMXVideoDecClass parent_class;
};

GType gst_omx_vc1_dec_get_type (void);

G_END_DECLS

#endif /* __GST_OMX_VC1_DEC_H__ */
