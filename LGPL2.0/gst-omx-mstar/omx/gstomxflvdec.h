...
#ifndef __GST_OMX_FLV_DEC_H__
#define __GST_OMX_FLV_DEC_H__
...
#define GST_TYPE_OMX_FLV_DEC \
  (gst_omx_flv_dec_get_type())
#define GST_OMX_FLV_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_OMX_FLV_DEC,GstOMXFLVDec))
#define GST_OMX_FLV_DEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_OMX_FLV_DEC,GstOMXFLVDecClass))
#define GST_OMX_FLV_DEC_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj),GST_TYPE_OMX_FLV_DEC,GstOMXFLVDecClass))
#define GST_IS_OMX_FLV_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_OMX_FLV_DEC))
#define GST_IS_OMX_FLV_DEC_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_OMX_FLV_DEC))

typedef struct _GstOMXFLVDec GstOMXFLVDec;
typedef struct _GstOMXFLVDecClass GstOMXFLVDecClass;

struct _GstOMXFLVDec
{
  GstOMXVideoDec parent;
};

struct _GstOMXFLVDecClass
{
  GstOMXVideoDecClass parent_class;
};

GType gst_omx_flv_dec_get_type (void);

G_END_DECLS

#endif /* __GST_OMX_FLV_DEC_H__ */
