...
#ifndef __GST_OMX_MVC_DEC_H__
#define __GST_OMX_MVC_DEC_H__
...
#define GST_TYPE_OMX_MVC_DEC \
  (gst_omx_mvc_dec_get_type())
#define GST_OMX_MVC_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_OMX_MVC_DEC,GstOMXMVCDec))
#define GST_OMX_MVC_DEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_OMX_MVC_DEC,GstOMXMVCDecClass))
#define GST_OMX_MVC_DEC_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj),GST_TYPE_OMX_MVC_DEC,GstOMXMVCDecClass))
#define GST_IS_OMX_MVC_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_OMX_MVC_DEC))
#define GST_IS_OMX_MVC_DEC_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_OMX_MVC_DEC))

typedef struct _GstOMXMVCDec GstOMXMVCDec;
typedef struct _GstOMXMVCDecClass GstOMXMVCDecClass;

struct _GstOMXMVCDec
{
  GstOMXVideoDec parent;
};

struct _GstOMXMVCDecClass
{
  GstOMXVideoDecClass parent_class;
};

GType gst_omx_mvc_dec_get_type (void);

G_END_DECLS

#endif /* __GST_OMX_MVC_DEC_H__ */
