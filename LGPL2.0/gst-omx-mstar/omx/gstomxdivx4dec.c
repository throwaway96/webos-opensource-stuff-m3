...
gst_omx_divx4_dec_class_init (GstOMXDIVX4DecClass * klass)
{
  ...
  gst_element_class_set_static_metadata (element_class,
      "OpenMAX DIVX 4 Video Decoder",
      "Codec/Decoder/Video",
      "Decode DIVX 4 video streams",
      "Sebastian Dröge <sebastian.droege@collabora.co.uk>");

  gst_omx_set_default_role (&videodec_class->cdata, "video_decoder.divx412");
}
    ...
    GstVideoCodecState * state)
{
  ...
  port_def.format.video.eCompressionFormat = OMX_VIDEO_CodingDIVX412;
