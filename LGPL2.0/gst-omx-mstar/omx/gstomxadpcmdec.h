...
#ifndef __GST_OMX_ADPCM_DEC_H__
#define __GST_OMX_ADPCM_DEC_H__
...
#define CALC_PTS_FROM_PCM   1

#define GST_TYPE_OMX_ADPCM_DEC \
  (gst_omx_adpcm_dec_get_type())
#define GST_OMX_ADPCM_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_OMX_ADPCM_DEC,GstOMXADPCMDec))
#define GST_OMX_ADPCM_DEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_OMX_ADPCM_DEC,GstOMXADPCMDecClass))
#define GST_OMX_ADPCM_DEC_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj),GST_TYPE_OMX_ADPCM_DEC,GstOMXADPCMDecClass))
#define GST_IS_OMX_ADPCM_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_OMX_ADPCM_DEC))
#define GST_IS_OMX_ADPCM_DEC_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_OMX_ADPCM_DEC))

typedef struct _GstOMXADPCMDec GstOMXADPCMDec;
typedef struct _GstOMXADPCMDecClass GstOMXADPCMDecClass;

struct _GstOMXADPCMDec
{
  GstOMXAudioDec parent;
  gint spf;
  guint32 block_align;
  GstClockTime adpcm_pts;
  gint32 sample_rate;
};

struct _GstOMXADPCMDecClass
{
  GstOMXAudioDecClass parent_class;
};

GType gst_omx_adpcm_dec_get_type (void);

G_END_DECLS

#endif /* __GST_OMX_ADPCM_DEC_H__ */
