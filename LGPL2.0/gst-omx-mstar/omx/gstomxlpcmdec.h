...
#ifndef __GST_OMX_LPCM_DEC_H__
#define __GST_OMX_LPCM_DEC_H__
...
#define GST_TYPE_OMX_LPCM_DEC \
  (gst_omx_lpcm_dec_get_type())
#define GST_OMX_LPCM_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_OMX_LPCM_DEC,GstOMXLPCMDec))
#define GST_OMX_LPCM_DEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_OMX_LPCM_DEC,GstOMXLPCMDecClass))
#define GST_OMX_LPCM_DEC_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj),GST_TYPE_OMX_LPCM_DEC,GstOMXLPCMDecClass))
#define GST_IS_OMX_LPCM_DEC(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_OMX_LPCM_DEC))
#define GST_IS_OMX_LPCM_DEC_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_OMX_LPCM_DEC))

typedef struct _GstOMXLPCMDec GstOMXLPCMDec;
typedef struct _GstOMXLPCMDecClass GstOMXLPCMDecClass;

struct _GstOMXLPCMDec
{
  GstOMXAudioDec parent;
  gint spf;
};

struct _GstOMXLPCMDecClass
{
  GstOMXAudioDecClass parent_class;
};

GType gst_omx_lpcm_dec_get_type (void);

G_END_DECLS

#endif /* __GST_OMX_LPCM_DEC_H__ */
