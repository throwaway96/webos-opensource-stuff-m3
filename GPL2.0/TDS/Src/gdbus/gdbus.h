...
typedef void (*GDBusPropertySetter)(const struct GDBusPropertyTable *property,
            DBusMessageIter *value, GDBusPendingPropertySet id,
            void *data);

typedef gboolean (*GDBusPropertyExists)(const struct GDBusPropertyTable *property,
                                void *data);
...
struct GDBusMethodTable {
    ...
    enum GDBusMethodFlags flags;
    unsigned int privilege;
    const struct GDBusArgInfo *in_args;
    const struct GDBusArgInfo *out_args;
};

struct GDBusSignalTable {
    const char *name;
    enum GDBusSignalFlags flags;
    const struct GDBusArgInfo *args;
};
...
struct GDBusPropertyTable {
    ...
    enum GDBusPropertyFlags flags;
};

struct GDBusSecurityTable {
    unsigned int privilege;
    const char *action;
    enum GDBusSecurityFlags flags;
